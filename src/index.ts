...
// Middleware
app.use(cors({
  origin: process.env.CLIENT_URL ? [process.env.CLIENT_URL, 'http://localhost:5173', 'http://127.0.0.1:5173'] : ['https://curabot-assistant.vercel.app', 'http://localhost:5173', 'http://127.0.0.1:5173'],
